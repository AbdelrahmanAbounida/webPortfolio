...
export const projects = [
...

    {
        ...
        tools:["MaterialUI","React","API"],
        live_url:"https://abounidayoutube.netlify.app/",
        details: "a Youtube Clone website using React and youtube API",
        imgName:"youtube",
...

    {
        ...
        tools:["React", "Redux"],
        imgName:"excelModel",
        details:"Excel Model dashboard using React, Redux",
...

    {
        ...
        tools:["Flask", "OpenAI","Langchain"],
        imgName:"tubeExplainer",
    ...
    {
        title:"Custom Pin Detection ",
        tools:["Yolov7", "Computer Vision"],
        imgName:"pin",
    ...
    },
    {
        ...
        tools:["MaterialUI","React","API"],
        live_url:"https://movie-recommendation-engine.netlify.app/",
        details: "Simple Single web page using React and axios",
        imgName:"movie",
...

    {
        title:"Fish Game",
        tools:["Javascript"],
        details:"2D game using javascript, html(canvas)",
        github_url:"https://github.com/AbdelrahmanAbounida/Fish-Game",
        imgName:"fish",
        github_url:"",
        live_enabled:false,
        github_enabled:true,
